...
public class If implements Serializable {
    ...
    public final Object elseResult;
    ...
    public If(Object result, Condition condition) {
        ...
        this.elseResult = null; // This will never be used
    }
    
    public If(Object result, Condition condition, Object elseResult) {
        this.resultType = ResultType.SINGULAR;
        this.result = result;
        this.resultCollection = null; // This will never be used
        this.condition = condition;
    ...
    public String toString() {
        ...
        if (isTrue) {
            ...
            if (this.elseResult != null) {
                value = this.elseResult.toString();
            } else {
                value = DEFAULT_VALUE;
            }
        }
